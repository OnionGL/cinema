...
const Headers = () => {
   ...
   const SubmitForm = (value) => {
      history.push(`/cinema/${value}`)
   }   
   const SearchSort = (value) => {
      setOrder(value.target.value)
   }  
   const SubmitFilter = () => {
      history.push(`/cinemaByFilter/${ratingfrom === undefined ? 0 : ratingfrom}/${ratingto === undefined ? 10 : ratingto}/${yearfrom === undefined ? 1950 : yearfrom}/${yearto === undefined ? 2020 : yearto}/${genre === undefined ? 1750 : genre}/${order === undefined ? "RATING" : order}`)
   } 
